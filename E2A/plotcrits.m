...
bins = 0:9;
data=permute(sum(generalization,1),[3,2,1]);
...
% 	bar(bins,data(:,i),1,'facecolor',colors(i,:),'linewidth',lwidth)
	...
	hist(data(:,i),bins)
	set(get(gca,'child'),'FaceColor',colors(i,:),'EdgeColor','k','linewidth',lwidth);
...
set(gcf, 'color', 'w');
fname = '/Users/nolan/Desktop/XOR/partial-xor-pbr/figs/e2ahistogram.tex';
matlab2tikz(fname);

...
for  i =1:4
	hs = [];
	for  j =1:2
		h = bar(x(j),ms(i,j),17,'FaceColor', barcolors(j,:),'linewidth',lwidth/2);
		hs = [hs h];
...
l = legend(hs,{'Proximity','Extrapolator'},...
	'orientation','vertical','location','northeastoutside','box','off','units','pix');
...
set(gcf, 'color', 'w');
fname = '/Users/nolan/Desktop/XOR/partial-xor-pbr/figs/e2abarsplit.tex';
matlab2tikz(fname);
